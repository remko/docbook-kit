...
def generate(env, docbookkit_dir, docbook_dir) :
  ...
  env.Command("fop.cfg", [], 
      'echo "<fop version=\\\"1.0\\\"><renderers><renderer mime=\\\"application/pdf\\\"><fonts><directory recursive=\\\"true\\\">docbook-kit/fonts</directory></fonts></renderer></renderers></fop>" > $TARGET')
